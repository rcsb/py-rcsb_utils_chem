...
class ChemCompMoleculeProvider(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.__ccUrlTarget = self.__ccUrlTarget if self.__ccUrlTarget else "https://prerelease.k8s.rcsb.org/pdb/data/monomers/components.cif.gz"
        self.__birdUrlTarget = kwargs.get("birdUrlTarget", None)
        self.__birdUrlTarget = self.__birdUrlTarget if self.__birdUrlTarget else "https://prerelease.k8s.rcsb.org/pdb/data/bird/prd/prdcc-all.cif.gz"
        #
